...
namespace arthur\tests\cases\g11n;

use arthur\g11n\Locale;
use arthur\action\Request as ActionRequest;
use arthur\console\Request as ConsoleRequest;

class LocaleTest extends \arthur\test\Unit 
{
