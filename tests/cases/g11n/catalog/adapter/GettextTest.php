...
namespace arthur\tests\cases\g11n\catalog\adapter;

use Exception;
use arthur\core\Libraries;
use arthur\tests\mocks\g11n\catalog\adapter\MockGettext;

class GettextTest extends \arthur\test\Unit 
{
	public $adapter;
	protected $_path;
	...
	public function testWrittenPoHasShortFilePaths() 
	{
		...
		$data = array(
			'singular 1' => array(
				...
				'translated'  => array('translated 1-0', 'translated 1-1'),
				'occurrences' => array(
					array('file' => ARTHUR_APP_PATH . '/testa.php', 'line' => 22),
