...
namespace arthur\tests\cases\storage;

use arthur\storage\Session;
use arthur\storage\session\adapter\Memory;
use arthur\tests\mocks\storage\session\adapter\SessionStorageConditional;

class SessionTest extends \arthur\test\Unit 
{
	...
	public function testSessionInitialization() 
	{
		...
		Session::config(array('store1' => array(
			'adapter' => 'arthur\storage\session\adapter\Memory',
			'filters' => array()
		)));
	...
	public function testStrategies() 
	{
		Session::config(array('primary' => array(
			'adapter' => new Memory(), 'filters' => array(), 'strategies' => array(
				'arthur\storage\cache\strategy\Json'
			)
		)));
