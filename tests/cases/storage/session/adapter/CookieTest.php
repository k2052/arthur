...
use arthur\storage\session\adapter\Cookie;

class CookieTest extends \arthur\test\Unit 
{
	...
	{
		$cookie   = new Cookie();
		$expected = Inflector::slug(basename(ARTHUR_APP_PATH)) . 'cookie';
