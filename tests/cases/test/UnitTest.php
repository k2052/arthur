...
use arthur\tests\mocks\test\MockUnitTest;
use arthur\tests\mocks\test\cases\MockSkipThrowsException;
use arthur\tests\mocks\test\cases\MockTestErrorHandling;

class UnitTest extends \arthur\test\Unit 
{
	...
	public function testSubject() 
	{
		...
		$expected = 'arthur\\tests\\mocks\\test\\MockUnit';
		$result   = $test->subject();
		$this->assertEqual($expected, $result);
	}
	...
	{
		$test = static::get('arthur\test\Unit');
