...
namespace arthur\tests\cases\util\collection;

use arthur\util\collection\Filters;

class FiltersTest extends \arthur\test\Unit 
{
	...
	public function testRun() 
	{
		...
		$expected .= ' arthur\tests\cases\util\collection\FiltersTest class.';
	...
	{
		$class = 'arthur\tests\mocks\util\MockFilters';
