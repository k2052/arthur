...
class StringTest extends \arthur\test\Unit 
{
	...
	{
		$string   = '2 + 2 = {:sum}. Arthur is {:adjective}.';
		$expected = '2 + 2 = 4. Arthur is yummy.';
		...
		$string = '2 + 2 = 2sum2. Arthur is 9adjective9.';
		$result = String::insert($string, array('sum' => '4', 'adjective' => 'yummy'), array(
			'format' => '/([\d])%s\\1/'
		));
		$this->assertEqual($expected, $result);

		$string   = '2 + 2 = 12sum21. Arthur is 23adjective45.';
		$expected = '2 + 2 = 4. Arthur is 23adjective45.';
		$result   = String::insert($string, array('sum' => '4', 'adjective' => 'yummy'), array(
			'format' => '/([\d])([\d])%s\\2\\1/'
		));
		$this->assertEqual($expected, $result);
		...
		$string   = '2 + 2 = <sum. Arthur is <adjective>.';
		$expected = '2 + 2 = <sum. Arthur is yummy.';
		$result   = String::insert($string, array('sum' => '4', 'adjective' => 'yummy'), array(
			'before' => '<', 'after' => '>'
		));
		$this->assertEqual($expected, $result);
		...
		$result = String::insert('{:me} arthur. {:subject} {:verb} fantastic.', array(
			'me' => 'I :verb', 'subject' => 'arthur', 'verb' => 'is'
		));
		$expected = "I :verb arthur. arthur is fantastic.";
		$this->assertEqual($expected, $result);
