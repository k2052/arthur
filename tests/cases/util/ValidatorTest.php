...
class ValidatorTest extends \arthur\test\Unit 
{
	...
	public function testAddCustomRegexFormats() 
	{
		...
		$this->assertFalse(Validator::isPhone('0800-ARTHUR'));
		Validator::add(array('phone' => array('foo' => '/^0800-[A-Z]+$/')));

		$this->assertTrue(Validator::isPhone('0800-ARTHUR'));
		$this->assertTrue(Validator::isPhone('0800-ARTHUR', 'foo'));
		$this->assertTrue(Validator::isPhone('0800-ARTHUR', 'any'));
	}
