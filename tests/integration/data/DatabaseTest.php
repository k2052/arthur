...
namespace arthur\tests\integration\data;

use arthur\data\Connections;
use arthur\data\model\Query;
use arthur\tests\mocks\data\source\Images;
use arthur\tests\mocks\data\source\Galleries;
use arthur\util\String;

class DatabaseTest extends \arthur\test\Integration 
{
	public $db = null;
	protected $_dbConfig;
	...
	public function testManyToOne() 
	{
		...
		$query = new Query($opts + array(
			'type'   => 'read',
			'model'  => 'arthur\tests\mocks\data\source\Images',
			'source' => 'images',
			'alias'  => 'Images',
	...
	public function testOneToMany() 
	{
		...
		$query = new Query($opts + array(
			'type'   => 'read',
			'model'  => 'arthur\tests\mocks\data\source\Galleries',
			'source' => 'galleries',
			'alias'  => 'Galleries',
			'with'   => array('Images')
		));
