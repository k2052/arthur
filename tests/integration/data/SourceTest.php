...
use arthur\tests\mocks\data\Company;
use arthur\tests\mocks\data\Employee;

class SourceTest extends \arthur\test\Integration 
{
	protected $_connection = null;

	protected $_classes = array(
		'employee' => 'arthur\tests\mocks\data\Employee',
		'company'  => 'arthur\tests\mocks\data\Company'
	);
